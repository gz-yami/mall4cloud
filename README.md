...
具体目录结构和二次开发阅读路径，可以查看 [技术文档](doc/README.md)。
...
![商务二维码](doc/img/readme/商务二维码.png)
...
| mall4cloud-product    商品服务                       | http://127.0.0.1:9104 |
...
部署教程请参考 [环境搭建](doc/2-环境搭建/README.md) 和 [中间件 Docker Compose](doc/8-部署运维/2-中间件-docker-compose/README.md)。
