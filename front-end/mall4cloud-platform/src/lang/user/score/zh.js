export default {
  ...
  growthSwitch: '成长值开关：',
  perPurchase: '购买商品每消费：',
  rechargeGrowthValue: '充值赠送成长值',
  getOneGrowth: '获取一点成长值',
  completedOrderGet: '每完成一笔订单获取：',
  growth: '成长值',
  levelPageSet: '等级页展示设置',
  growthDescription: '会员权益',
  memberBenefitsPageDisplaySet: '会员权益页展示设置',
  displayContent: '展示内容：',
  levelPageConfiguration: '等级页展示配置',
  memberGrowthDescription: '会员中心成长值说明',
  consumptionGetGrowthCannotEmpty: '请输入正确的消费金额获取成长值',
  rechargeGetGrowthCannotEmpty: '充值赠送成长值不能为空',
  growthEarnSetting: '成长值获取设置',
  orderAcquisitionCannotEmpty: '请输入正确的订单获取成长值',
  pointsSet: '积分基础设置',
